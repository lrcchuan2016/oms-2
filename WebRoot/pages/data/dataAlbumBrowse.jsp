...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">相册浏览统计</li>
    </ol>
    
    <div class="userListbox">
    	<form action="javascript:void(null);" id="albumBrowseForm">
...
function bindReSearch(){
	$(".reSearch").livequery(function(){
		$(this).change(function(){
			var param = filter($("#albumBrowseForm").serialize(),"-1");
			loadData(param);
		});
	});
}
...
function loadData(param){
	$.ajax({
		...
		dataType:'json',
		data:param,
		url:'json/albumDataStatistics_QueryAlbumSurfedDatatistics',
