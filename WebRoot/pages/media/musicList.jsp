...
<div class="container-fluid">
	<ol class="breadcrumb">
      ...
      <li class="active">普通音乐推荐</li>
    </ol>
    <div class="userListbox channel-list" style="margin-right:20px;">
    	<ul class="nav nav-tabs">
          <li role="presentation" class="active"><a href="mediaPages_musicList">普通推荐音乐</a></li>
          <li role="presentation"><a href="mediaPages_themeMusic">主题推荐音乐</a></li>
    	...
    	<form class="retrieval" id="searchForm" action="javascript:void(null);">
    		...
    		<input class="hide" name="paramMap['searchType']" value="0">
           ...
           &nbsp;<button type="submit" id="searchBtn" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> 搜索</button>
	         <div class="pull-right btn-group">
	           		<a href="mediaPages_mediaAdd?option=0&&type=2" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;上传音乐</a>
...
$(function(){
	...
	musicTableObj = $("#musicTable").tableList({
        ...
        param:"paramMap['searchType']=0&&paramMap['audit_status']=0",
        pageSize:12,
        paging:true,
...
function htmlTemplate(index, data, recordIndex){
	...
	html += '<td><div class="btn-group"><button class="btn btn-danger btn-xs del" id="'+data.mediaId+'"><span class="glyphicon glyphicon-minus-sign"></span> 删除</button><button class="btn btn-warning btn-xs edit" id="'+data.mediaId+'"><span class="glyphicon glyphicon-edit"></span> 编辑</button></div></td>';
...
function initMusic(){
	...
	$(".del").unbind("click").bind("click",function(){
		var url = mapObj.get("t_"+$(this).parents("tr").attr("id")).url;
		var id = $(this).parents("tr").attr("id");
		var $param = "mediaList[0].id="+id+"&mediaList[0].content="+url+"&mediaList[0].type=2";
		alertObj.cancel();
		alertObj.check({
            needConfirm:true,
