           ...
           <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="userAction_getAlbumMedia?paramMap['option']=3&&paramMap['id']=${userBean.id }">锁定的图片</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
          </div><!-- /.container-fluid -->
        </nav>
        ...
        <div class="user-content">
            ...
            <div class="user-album-list clearfix albumID" id='<s:property value="albumID"/>'>
                <ul class="clearfix">
                   ...
                   <s:if test='audit_status=="0"'><li class="status0" id='<%="album" %><s:property value="id"/>'></s:if>
                   <s:elseif test='audit_status=="1"'><li class="status" id='<%="album" %><s:property value="id"/>'></s:elseif>
                   <s:else><li class="locked status" id='<%="album" %><s:property value="id"/>'></s:else>
...
$(function(){
	...
	//初始化 相册列表
	$(".user-album-list > ul > li.status").livequery(function(){
		$(this).hover(function(){
