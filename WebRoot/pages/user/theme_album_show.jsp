          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li><a href="userAction_selectUserBean?uid=${userBean.id }">基本信息</a></li>
...
$.extend({
	...
	skip:function(){
		...
		if(regex.test(page) && parseInt(page)<= parseInt(totalPage) && parseInt(page)>= 1){
			window.location.href="userAction_showAlbumTheme?paramMap['id']="+id+"&paramMap['albumId']="+albumId+"&page="+page;
		}else{
