          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="line"></li>
                <li class="active"><a href="userAction_showLockAlbum?paramMap['id']=${userBean.id }">锁定的相册</a></li>
            ...
            <div class="user-album-list clearfix">
                <ul class="clearfix">
                    ...
                    <s:else>
                    	...
                    	<s:if test='type=="0"'>
                    	<a href="userAction_showAlbumPhoto?paramMap['id']=${userBean.id }&&paramMap['albumId']=${id}"><img class="imgSrc" src='<s:property value="cover"/>'></a>
                       	</s:if>
                       	<s:elseif test='type=="1"'>
                       	<a href="userAction_showAlbumTheme?paramMap['id']=${userBean.id }&&paramMap['albumId']=${id}"><img class="imgSrc" src='<s:property value="cover"/>'></a>
                       	</s:elseif>
                       	<s:else>
                       	<a href="userAction_showAlbumTimer?paramMap['id']=${userBean.id }&&paramMap['albumId']=${id}"><img class="imgSrc" src='<s:property value="cover"/>'></a>	
                       	</s:else>
                        <div class="info">
...
$.extend({
	...
	skip:function(){
		...
		if(regex.test(page) && parseInt(page)<= parseInt(totalPage) && parseInt(page)>= 1){
			window.location.href="userAction_showLockAlbum?paramMap['id']="+id+"&page="+page;
		}else{
