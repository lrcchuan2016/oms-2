...
function fillUl(medias){
	///if(medias.size()>0){
		var ul = $(".user-album-list > ul");
		$.each(medias,function(i,media){
			var html = '';
			if(media.audit_status == '2'){
				html += '<li id="album'+media.id+'" class="locked">';
			}else html += '<li id="album'+media.id+'">';
	        html += '<a href="javascript:void(0)"><img src="'+media.content+'@1e_160w_160h_1c_0i_1o_100Q_1x.jpg"></a>';
	        html +=  '<div class="info">';
