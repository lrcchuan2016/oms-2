...
<div class="container-fluid">
    ...
    <div class="userListbox">
    	<ul class="nav nav-tabs">
          ...
          <li role="presentation"><a href="pages/push/iosMsgSingle.jsp?type=0">推送消息给单个设备</a></li>
          <li role="presentation" class="active"><a href="pages/push/iosMsgMulti.jsp?type=0">推送消息给所有设备</a></li>
        </ul>
