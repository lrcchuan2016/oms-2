...
<div class="container-fluid">
    ...
    <div class="userListbox">
    	<ul class="nav nav-tabs">
          <li role="presentation"><a href="pages/push/androidMsg.jsp">信鸽配置信息</a></li>
          <li role="presentation" class="active"><a href="pages/push/androidMsgSingle.jsp">推送消息给单个设备</a></li>
