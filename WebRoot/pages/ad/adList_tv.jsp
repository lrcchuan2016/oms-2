...
<div class="container-fluid">
    ...
    <div class="userListbox ad-list">
       ...
       <ul class="nav nav-pills">
          ...
          <li role="presentation" class="active"><a href="adAction_adList?adType=2">电视广告</a></li>
          <li role="presentation"><a href="adAction_adList?adType=3">网站广告</a></li>
          <li role="presentation"><a href="adAction_adList?adType=0">全局广告</a></li>
        </ul>
               	  ...
               	  <tr id='<s:property value="id"/>'>
                      ...
                      <td>
                     	...
                     	<s:if test='contentType=="1"'>
                     		<video class="img-responsive img-thumbnail" preload="auto" controls width="250px" height="150px" src="<s:property value='content'/>"></video>
                     	</s:if>
...
$(function(){
	...
	$('#file_upload').uploadify({
		...
		'swf'      : 'public/uploadify/css/uploadify.swf',
		'uploader' : 'uploadify.jsp',
		'buttonText' : '<span class="glyphicon glyphicon-arrow-up"></span>上传新的视频',
		'fileTypeExts' : '*.mp4;',
