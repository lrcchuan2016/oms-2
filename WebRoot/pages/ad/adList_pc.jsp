...
<div class="container-fluid">
    ...
    <div class="userListbox ad-list">
        ...
        <ul class="nav nav-pills">
          ...
          <li role="presentation" class="active"><a href="adAction_adList?adType=3">网站广告</a></li>
               	  ...
               	  <tr id="<s:property value="id"/>">
                      ...
                      <td>
                     	...
                     	<s:if test='contentType=="1"'>
                     		<video class="img-responsive img-thumbnail" controls width="100%" src="<s:property value='content'/>"></video>
                     	</s:if>
