	    ...
	    <div class="col-xs-12 no-padder">
			<div class="panel panel-default no-padder">
				<div class="panel-heading">
					<h4>添加分组&nbsp;&nbsp;<span class="badge"><span class="glyphicon glyphicon-star"></span>号开头的为必填项. &nbsp;&nbsp;&nbsp;</h4>
				</div>
						...
						<div class="row col-xs-8">
							<div class="col-xs-12">
								<div class="form-group">
									<label class=""><span class="glyphicon glyphicon-star">分组图标</span></label>
									<input class="form-control" readonly name="decorateGroupList[0].iconUrl" data-valid="[{rule:'not_empty'}]" type="text" placeholder="云存储路径 [不可更改]">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label class=""><span class="glyphicon glyphicon-star"></span>分组编码</label>
									<input class="form-control" type="text" name="decorateGroupList[0].id" readonly maxlength="20" data-valid="[{rule:'not_empty'}]" placeholder="上传图标后获得随机编码">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label class=""><span class="glyphicon glyphicon-star"></span>分组名称</label>
									<input class="form-control" type="text" name="decorateGroupList[0].name" maxlength="20" data-valid="[{rule:'not_empty'}]" placeholder="decorate Name">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label class="">分组详情</label>
									<textarea class="form-control" name="decorateGroupList[0].detail" rows="4" maxlength="1000"></textarea>
								</div>
							</div>
						</div>
...
$(function(){
	...
	actionObj = new Actions({
		url:"json/decorate_addDecorateGroup", 
		 	...
		 	if(data!=null&&response!=null){
		 		if(data!=""){
			 		...
			 		if(response==true && resultData.result=="00000000"){
			 			...
			 			$("input[name='decorateGroupList[0].id']").val(resultData.productKey);
