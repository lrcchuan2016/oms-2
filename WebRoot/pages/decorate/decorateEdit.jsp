		...
		<div class="col-xs-12 no-padder">
			<div class="panel panel-default no-padder">
				<div class="panel-heading">
					<h4>编辑装饰品&nbsp;&nbsp;<span class="badge"><span class="glyphicon glyphicon-star"></span>号开头的为必填项. &nbsp;&nbsp;&nbsp;</h4>
				</div>
						...
						<div class="row col-xs-8">
							<div class="col-xs-12">
								<div class="form-group">
									...
									<input class="form-control " readonly name="decorateList[0].url" value="${decorateBean.url }" data-valid="[{rule:'not_empty'}]" type="text" placeholder="云存储路径 [不可更改]">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label class=""><span class="glyphicon glyphicon-star"></span>装饰品编码</label>
									<input class="form-control resultKey" type="text" readonly name="decorateList[0].id" value="${decorateBean.id }" maxlength="20" data-valid="[{rule:'not_empty'}]" placeholder="上传图标后自动获取到装饰品编码">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<label class=""><span class="glyphicon glyphicon-star"></span>装饰品名称</label>
									<input class="form-control " type="text" name="decorateList[0].name" maxlength="20" value="${decorateBean.name }" data-valid="[{rule:'not_empty'}]" placeholder="填写装饰品名称">
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
...
var mapObj = new HashMap(),formObj = null,actionObj = null,uploadProgressTimeout = -1,uploadTime = 0,groupName = "${decorateBean.groupName}",mid;
...
$(function(){
	...
	actionObj = new Actions({
		url:"json/decorate_editDecorate", 
	...
	$(".subBtn").click(function(){
		if(formObj.validate_all()){
			...
			if(resultKey!="") $editParam += "&paramMap['decorateEdit']="+resultKey+"&paramMap['mid']="+mid;
        	actionObj.submit({ 
        		param:$editParam
        	});
		}
