...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="javascript:history.back();">${terminal.name }</a></li>
      <li class="active">新建版本</li>
    </ol>
    
    <div class="row channel-add" style="padding:0px 20px;">
            <div class="panel panel-default clearfix">
              <div class="panel-heading">新建版本</div>
              <form action="javascript:void(null)" id="softVersionForm">
              <div class="panel-body col-md-8">
              	<div class="form-group">
                    <input type="hidden" class="form-control" value="${terminal.id }" name="id" data-valid="[{rule:'not_empty'}]">
                  </div>
                  <div class="form-group">
                    <label for="terminal_name">版本号</label>
                    <input type="text" class="form-control" id="terminal_name" name="softVersion.versionNum" data-valid="[{rule:'not_empty'}]" placeholder="如： v1.0.11">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div id="fileBox">
                    	<a href="javascript:void(0)" class="btn btn-lg btn-default"><i class="iconfont">&#xf00bd;</i>&nbsp;<span class="fileName"></span></a>
                        <a href="javascript:void(0)"><i class="iconfont">&#xf013f;</i></a>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label for="versionMd5">版本编码</label>
                    <input type="text" class="form-control" readonly id="versionMd5" name="softVersion.id" data-valid="[{rule:'not_empty'}]" placeholder="上传后获得">
                  	<input type="hidden" class="form-control" id="url" name="softVersion.softUrl">
                  </div>
                  
                  <div class="form-group">
                    <label for="terminal_name">SVN URL</label>
                    <input type="text" class="form-control" id="terminal_name" name="softVersion.svnUrl" data-valid="[{rule:'not_empty'}]" placeholder="如：http://">
                  </div>
                  
                  <div class="form-group">
                    <label>版本说明</label>
                    <textarea class="form-control" id="introduce" rows="2" placeholder="版本说明" data-valid="[{rule:'not_empty'}]" name="softVersion.description"></textarea>
                  </div>
