    ...
    <div class="userListbox channel-list" style="margin-right:20px;">
		...
		<div class="panel panel-default clearfix">
			<div class="panel-heading">
				添加模版&nbsp;&nbsp;<span class="badge"><span class="glyphicon glyphicon-star"></span>号开头的为必填项. &nbsp;&nbsp;&nbsp;<span class="text-warning">[注]:</span>上传较大模版封面可能耗时比较长，请耐心等待</span>
			</div>
					...
					<div class="row col-xs-8">
						<div class="col-xs-12">
							<div class="form-group">
								<label class=""><span class="glyphicon glyphicon-star"></span>模版封面</label>
								<input class="form-control" readonly name="templateList[0].coverUrl" data-valid="[{rule:'not_empty'}]" type="text" placeholder="云存储路径 [不可更改]">
							</div>
						</div>
						<div class="col-xs-12">
							<div class="form-group">
								<label class=""><span class="glyphicon glyphicon-star"></span>模版编码</label>
								<input class="form-control" type="text" readonly name="templateList[0].id" maxlength="20" data-valid="[{rule:'not_empty'}]" placeholder="上传封面图后自动获取到模版编码">
							</div>
						</div>
						<div class="col-xs-12">
							<div class="form-group">
								<label class=""><span class="glyphicon glyphicon-star"></span>模版名称</label>
								<input class="form-control" type="text" name="templateList[0].name" maxlength="20" data-valid="[{rule:'not_empty'}]" placeholder="填写模版名称">
							</div>
						</div>
						<div class="col-xs-12">
							<div class="form-group">
								<label class=""><span class="glyphicon glyphicon-star"></span>模版类别</label>
								<select name="templateList[0].groupId" class="form-control"></select>
							</div>
						</div>
						<div class="col-xs-12">
							<div class="form-group">
								<label class="">模版简介</label>
								<textarea class="form-control" name="templateList[0].introduction" rows="4" maxlength="1000"></textarea>
							</div>
						</div>
					</div>
			...
			<div class="panel-footer pull-left col-md-8">
		 	...
		 	if(data!=null&&response!=null){
		 		if(data!=""){
			 		...
			 		if(response==true && resultData.result=="00000000"){
			 			...
			 			$("input[name='templateList[0].id']").val(resultData.productKey);
