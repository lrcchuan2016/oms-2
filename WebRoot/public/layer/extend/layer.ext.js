...
layer.photos = function(options){
    ...
    if(json){
        ...
        if(json.status === 1){
            ...
            if(data.length > 0){
                log.thissrc = data[json.start].multimediaURL;
                log.pid = data[json.start].id;
                log.imgsname = (data[json.start].multimediaName || '');
                log.name = data[json.start].multimediaName;
        ...
        log.imgsname = (data[log.imgIndex].multimediaName || '');
    ...
    var conf = {
        ...
        page: {
            ...
            }() +'<div class="xubox_imgbar"><span class="xubox_imgtit"><a id="imgName_layer_photos_name" href="javascript:;">'+ log.imgsname +' </a><span>'+ log.imgIndex +'/'+ log.imgLen +'</span></span></div></div></div>'+ function(){
                if(options.html){
    ...
    log.event = function(){
        ...
        log.tabimg = function(){
            ...
            if(json){
                ...
                src = nowdata.multimediaURL;
                pid = nowdata.id;
                name = nowdata.multimediaName;
			...
			window.top.$("#imgName_layer_photos_name").html(name);
