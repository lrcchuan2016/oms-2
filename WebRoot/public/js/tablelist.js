...
(function($) {
    ...
    TableList.prototype = {
        init:function(element, options) {
            ...
            this.$table = $(element);
            this.$thead = this.$table.find(".table-head"),this.$tbody = this.$table.find("tbody"), 
        ...
        setOptions:function(options) {
            ...
            if (this.options.paging) {
                ...
                this.page_options = {
                    size:"small",
                    alignment:"center",
                    skipBtnShow:true,    //是否显示跳页面输入框和按钮
        ...
        initTableList:function() {
            ...
            $.post(this.options.url, param, function(data) {
                if (self.options.paging) {
                    ...
                    self.page_options.totalCount = pageObj.totalCount;   //==================
        ...
        initTableListByData:function(dataList) {
            ...
            $.each(this.dataList, function(i) {
                if (typeof self.options.template === "function") {
                    self.$thead.after(self.options.template(i, this));
                }
            });
            $(".alt").tooltip({
                placement:"bottom"
